                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('userPic') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="userPic" type="file" class="form-control" name="userPic" value="{{ old('userPic') }}" required autofocus>

                                @if ($errors->has('userPic'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('userPic') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
